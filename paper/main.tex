...
The conversation opens by collecting basic context about the EdTech application and how it works: what the application does, who its learners are, the domain, and a description of the typical user flow. This is followed by "ideation coaching," which gathers information about whether the user is interested in solving a specific problem, developing an intervention, or creating a feature. The system then helps identify where in the app's interaction flow an experiment might run. Users can upload files such as screenshots or documents to help the AI provide more specific follow-up questions and suggestions.
