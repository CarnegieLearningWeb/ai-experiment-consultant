...
Metrics:
  ...
  timeOnTask:     Mean
\end{verbatim}
\caption{Proposed UpGrade experiment design generated by the AI consultant for the ExampleMathApp hint-button scenario, handed off in the final report alongside hypothesis, simulation summary, recommended implementation order, and client-integration code guidance.}
